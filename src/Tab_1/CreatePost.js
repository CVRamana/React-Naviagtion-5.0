    ...
    let content = (
      ...
      style={{height:20,width:50,backgroundColor:"#24994f"}}>
        ...
        <View style={{flexDirection:"row",justifyContent:"space-between",width:380,}}>
          <TouchableOpacity
          activeOpacity={1}
          onPress={this._onPrevPress} ><Image
          style={{height:20,width:40,backgroundColor:"red"}} /> 
         
          </TouchableOpacity>
    <Text activeOpacity={1} style={{color:"green",height:30,width:100}}>Get Started</Text> 
        </View>
  }
        </View>
